...
# it will only print Thursday only cuz u already deleted the starting 2 element from the first by[0:2]
...
# if we dont use : then it creates a different memory address
print(id(backpack))
print(backpack)
